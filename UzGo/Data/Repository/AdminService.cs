...
namespace UzGo.Data.Repository
{
    ...
    // 
    //  [DebuggerVisualizer(typeof(AdminService))]
    //  [Serializable]
    ...
    /// </summary>
    public class AdminService : DialogDebuggerVisualizer
    {
        ...
        // 
        //    AdminService.TestShowVisualizer(new SomeType());
        // 
        /// <summary>
        ...
        {
            VisualizerDevelopmentHost visualizerHost = new VisualizerDevelopmentHost(objectToVisualize, typeof(AdminService));
